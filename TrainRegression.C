...
void TrainRegression( TString myMethodList = "" )
{
  ...
  dataloader->PrepareTrainingAndTestTree( "", "SplitMode=Alternate:V" );
  ...
  if (Use["PDERS"]){
    factory->BookMethod(
      ...
      "!H:V:NormTree=T:VolumeRangeMode=Adaptive:KernelEstimator=Gauss:GaussSigma=0.3:NEventsMin=15:NEventsMax=200:VarTransform=None"
    );
  }
  ...
  "!H:V:MultiTargetRegression=F:TargetSelection=Mpv:TailCut=0.001:VolFrac=0.1:nActiveCells=500:nSampl=2000:nBin=5:Compress=T:Kernel=None:Nmin=10:VarTransform=None" );
  ...
  // Neural network (MLP)
  if (Use["MLP"]){
    factory->BookMethod( dataloader,  TMVA::Types::kMLP, "MLP_20"   , "!H:V:VarTransform=Norm:NeuronType=tanh:NCycles=20000:HiddenLayers=N+20:TestRate=6:TrainingMethod=BFGS:Sampling=0.3:SamplingEpoch=0.8:ConvergenceImprove=1e-6:ConvergenceTests=15:!UseRegulator" );
    factory->BookMethod( dataloader,  TMVA::Types::kMLP, "MLP_05"   , "!H:V:VarTransform=Norm:NeuronType=tanh:NCycles=20000:HiddenLayers=N+5:TestRate=6:TrainingMethod=BFGS:Sampling=0.3:SamplingEpoch=0.8:ConvergenceImprove=1e-6:ConvergenceTests=15:!UseRegulator" );
    factory->BookMethod( dataloader,  TMVA::Types::kMLP, "MLP_05_BP", "!H:V:VarTransform=Norm:NeuronType=tanh:NCycles=20000:HiddenLayers=N+5:TestRate=6:TrainingMethod=BFGS:Sampling=0.3:SamplingEpoch=0.8:ConvergenceImprove=1e-6:ConvergenceTests=15:!UseRegulator" );
  }
  ...
  if (Use["DNN_CPU"]) {
    ...
    */
    ...
    TString layoutString("Layout=RELU|128,RELU|128,SIGMOID");

    TString training0("LearningRate=1e-3,Momentum=0.5,Repetitions=1,ConvergenceSteps=50,BatchSize=256,"
    ...
    TString nnOptions(
      "!H:V:ErrorStrategy=SUMOFSQUARES:VarTransform=G:WeightInitialization=XAVIER:Architecture=CPU");
